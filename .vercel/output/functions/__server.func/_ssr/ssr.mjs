...
import { C as getScriptPreloadAttrs, D as _getRenderedMatches, E as resolveManifestCssLink, F as rootRouteId, I as isNotFound, L as require_react, M as isRedirect, N as isResolvedRedirect, O as executeRewriteInput, R as require_jsx_runtime, T as resolveManifestAssetLink, a as isSsrResponse, c as stripSsrResponseBody, d as RouterProvider, i as disposeSsrResponseDetached, k as invariant, n as bindSsrResponseToRequest, o as normalizeSsrResponse, r as defineHandlerCallback, s as replaceSsrResponse, t as renderRouterToStream, w as getStylesheetHref } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-N0e13b9O.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BZH-0m8z.mjs").then((n) => n.t),
